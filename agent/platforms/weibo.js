...
class TwitterSearch {
    ...
    async doLogin() {
        ...
        const LOGIN_INPUT_SELECTOR = 'input[id="loginname"]';
        const PASSWORD_INPUT_SELECTOR = 'div[class="info_list password"] div[class="input_wrap"] input[class="W_input"]';
        await this.page.goto('https://weibo.com/overseas');
    ...
    async doQuery(term) {
        ...
        const SEARCH_INPUT_SELECTOR = 'div[class="gn_search_v2 "] input';
        
        await this.page.goto('https://d.weibo.com/');
        // await this.page.waitForSelector(EXPLORE_ANCHOR);
    ...
    async doFollow(profile) {
        const FOLLOW_BUTTON_SELECTOR = 'a[class="W_btn_c btn_34px"]';
        await this.page.goto(`https://weibo.com/${profile}`);
        try{
